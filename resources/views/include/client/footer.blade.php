...
<script type="text/javascript" src="{{ asset('src/plugins/chart.js/js/Chart.js') }}"></script>

<script type="text/javascript" src="{{ asset('src/plugins/dashboard/amchart/js/amcharts.js') }}"></script>
<script type="text/javascript" src="{{ asset('src/plugins/dashboard/amchart/js/serial.js') }}"></script>
<script type="text/javascript" src="{{ asset('src/plugins/dashboard/amchart/js/light.js') }}"></script>

<script type="text/javascript" src="{{ asset('src/plugins/prism/custom-prism.js') }}"></script>

<script type="text/javascript" src="{{ asset('src/js/pcoded.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('src/js/menu/menu-hori-fixed.js') }}"></script>
<script type="text/javascript" src="{{ asset('src/js/jquery.mCustomScrollbar.concat.min.js') }}"></script>
