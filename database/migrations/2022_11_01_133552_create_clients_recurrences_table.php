...
class CreateClientsRecurrencesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('clients_recurrences', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('clients_recurrences');
    }
}
