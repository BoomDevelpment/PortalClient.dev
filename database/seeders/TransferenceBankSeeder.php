...
class TransferenceBankSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $iData  =   [
            ...
            'dni'           =>  '123456789',
            'account'       =>  '0174'.random_int(10000000, 99999999),
        ...
        if($reg)
        {
            ...
            $iPend   =   [
                ...
                'status'        =>  $status->id,
                'method'        =>  TransferenceMethod::where('name', 'like', '%trans%')->first()->id
            ];
            ...
            {
                $report             =   TransferenceBank::where('identified', '=', $identified)->first();
